...
//------------
// Chapter 7 / Section 7.4 / Page 253
//	Adding an automated test driver to the Employee class
//------------ 
...
class Employee {
	...
	public static void testDriver() {
		...
		if (computedPay != correctAnswer) {
			System.out.print("*** Error - computed pay does not ");
